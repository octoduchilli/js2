<template>
  <div class="new column width align-center">
    <h1 class="title-sentence">Nouveaux</h1>
    ...
    <div class="card-messages column align-center" v-for="video in __videos" :key="video.tile">
